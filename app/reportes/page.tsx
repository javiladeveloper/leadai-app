  ...
  return (
    <div className="flex min-h-dvh flex-col">
      <header className="px-5 pt-[max(1.5rem,env(safe-area-inset-top))]">
        ...
        <h1 className="mt-1 text-[1.8rem] font-bold text-tinta">Tus resultados</h1>
      </header>

      <main className="flex-1 space-y-4 px-5 pb-6 pt-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={s.l} className="rounded-tarjeta bg-carta p-3.5 text-center shadow-[var(--sombra-tarjeta)] ring-1 ring-linea">
