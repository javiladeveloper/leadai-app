...
export async function invitarMiembro(email: string, rol: "admin" | "agente" | "ventas" | "marketing" | "mozo"): Promise<{ ok: boolean; token?: string; correoEnviado?: boolean; error?: string }> {
  try {
